		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hourly Cycle Report",
									"targetURL": "#comairbuszqmhycrpt-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comairbuszqmhycrpt-display": {
								"semanticObject": "comairbuszqmhycrpt",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.airbus.zqmhycrpt",
									"url": sap.ui.require.toUrl("com/airbus/zqmhycrpt")
								}
							}
						}
					}
